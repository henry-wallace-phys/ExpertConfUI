from expert_config_ui.daq_config.configuration.implementations.conffwk.conffwk_config import (ConffwkConfiguration,
...
class ConffwkBackend(IConfigBackend):
    ...
    def __init__(self, config_path: Optional[str] = None) -> None:
        ...
        self._PROPERTY_HANDLERS = {
            "class": ConffwkObjectHandler(self._CONFIGURATION)
        }