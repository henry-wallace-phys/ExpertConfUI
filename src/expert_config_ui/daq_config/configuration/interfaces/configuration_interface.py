...
@runtime_checkable
# *****************************************************************************
class __IObjectManager(Protocol):
# *****************************************************************************
    '''
    ...
    def get_all(self, object_class: Optional[str | List[str]] = None) -> List[object]:
        '''
...
@runtime_checkable
# *****************************************************************************
class INamedObjectManager(__IObjectManager, Protocol):
# *****************************************************************************
    '''
    Abstract base class for managing objects in a configuration.
    '''
    
    def get(self, object_class: str, object_name: str) -> object:
        '''
        Get an object of the specified class and name.
        :param object_class: Class of the object to retrieve.
        :param object_name: Name of the object to retrieve.
...
@runtime_checkable
# *****************************************************************************
class IClassObjectManager(__IObjectManager, Protocol):
# *****************************************************************************
    '''
    Abstract base class for managing objects in a configuration.
    '''
    
    def get(self, object_class: str) -> object:
        '''
        Get an object of the specified class and name.
        :param object_class: Class of the object to retrieve.
        :param object_name: Name of the object to retrieve.
...
# *****************************************************************************
    def set(self, obj: Any, attribute_name: str, attribute_value: Any) -> None:
        '''
    ...
    def get(self, obj: Any, attribute_name: str) -> Any:
        '''
...
@runtime_checkable    
# *****************************************************************************
class __IObjectLifecycle(Protocol):
# *****************************************************************************
    '''
...
@runtime_checkable    
# *****************************************************************************
class INamedObjectLifecycle(__IObjectLifecycle, Protocol):
# *****************************************************************************
...
@runtime_checkable    
# *****************************************************************************
class IClassObjectLifecycle(__IObjectLifecycle, Protocol):
# *****************************************************************************
...
# *****************************************************************************
    ...
    def __init__(self, config_type: ConfigType, configuration: IConfiguration):
        ...
        if not str(configuration.name).endswith(f"{config_type.name.lower()}{self.__CONFIG_NAME_EXTENSION}"):
            logging.exception(f"Configuration name must end with '{config_type.name.lower()}{self.__CONFIG_NAME_EXTENSION}'")
